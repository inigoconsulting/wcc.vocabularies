...
# Country Info from : https://gist.github.com/986163
COUNTRIES = [
...
'code': 'PF', 'continent': 'Oceania', 'name':'French Polynesia', 'capital':'Papeet\xc4'},
{'timezones': ['Pacific/Niue'], 'code': 'NU', 'continent': 'Oceania', 'name':'Niue', 'capital': 'Alofi'},
{'timezones': ['Pacific/Noumea'], 'code': 'NC', 'continent': 'Oceania','name':'New Caledonia', 'capital': 'Noum\xc3au'},
...
MAPPING = dict([(i['code'], i) for i in COUNTRIES])

def lookup_capital(code):
    if code in MAPPING:
        return MAPPING[code]['capital']
